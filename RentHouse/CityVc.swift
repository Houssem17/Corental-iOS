...
class CityVc: UITableViewController , UISearchBarDelegate {
    ...
    @objc func doSearch(_ word : String) {
        ...
        let username = self.defaults.object(forKey: "user_name") as! String
        
        let url = URL(string: "http://localhost:8888/RentHouse/users.php")!  // url path to users.php file
